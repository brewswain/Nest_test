...
//"an immutable object that encapsulates our data that
// we want to send from one place to another". In essentia, we can simply think of them as a box
// that we transfer specifically shaped data from one layer to a next.
